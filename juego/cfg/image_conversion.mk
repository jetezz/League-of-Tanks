...
PALETTE= 13 0 26  1 2 3 6 9 7 12 04 16 18 20 24 25 
...
$(eval $(call IMG2SP, CONVERT,assets/tankes8x16.png, 8, 16, cannons_sp, canons_pal2))
$(eval $(call IMG2SP, CONVERT,assets/plant.png, 8, 16, plant_sp))
$(eval $(call IMG2SP, CONVERT,assets/player.png, 32, 16, player_sp))
$(eval $(call IMG2SP, CONVERT,assets/bala.png, 4, 8, bala_sp))

$(eval $(call IMG2SP, CONVERT,assets/explosionTanque.png, 8, 16, canonExpl))
$(eval $(call IMG2SP, CONVERT,assets/balaExp.png, 4, 8, balaExpl_sp))



$(eval $(call IMG2SP, CONVERT,assets/2.png, 8, 16, spr2))
$(eval $(call IMG2SP, CONVERT,assets/3.png, 8, 16, spr3))
$(eval $(call IMG2SP, CONVERT,assets/4.png, 8, 16, spr4))

##TILEMAP

$(eval $(call IMG2SP, SET_FOLDER, src/mapas/ ))
$(eval $(call IMG2SP, SET_IMG_FORMAT, zgtiles))
$(eval $(call IMG2SP, SET_OUTPUT, c))
$(eval $(call IMG2SP, CONVERT, src/mapas/source/tiles32_32.png, 8, 8, tileset))
...
##$(eval $(call IMG2SPRITES,assets/canonp.png,0,sprite,8,12,$(PALETTE),,src/sprites,hwpalette))
